...
// ============================================================
// STYLES -- V5.1.1: Top toolbar      '*, *::before, *::after { box-sizing: border-box; margin:0; padding:0; }',
...
function buildLogoPanel(container) {
  ...
  panel.innerHTML = [
    ...
    '    <option value="top-right">Top Right</option<button class="sd-btn sd-logo-apply">Apply to All</button>',
...
function exportChart(slide, el, isDark, accent, pptx) {
  ...
  slide.addpush(headers.map(function (h) {
      return {
        text: h,
        options: {
          bold: true,
